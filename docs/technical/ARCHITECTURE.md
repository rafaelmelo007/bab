...
>
> See `docs/prds/draft/2026-05-23-bab.md` §5 (How it works) and §6.5 (Future architecture: optional daemon mode) for the current architectural intent.
>
...
> - State layout (`~/.config/bab/state.toml` + per-provider session IDs)
